...
//      Current Step:
//          https://developer.mozilla.org/en-US/docs/Learn_web_development/Extensions/Client-side_APIs/Client-side_storage#a_more_involved_example
...
submitBtn.addEventListener("click", () => {
    ...
    // run nameDisplayCheck() to short out displaying the personalized greetings and updating the form display
    nameDisplayCheck();
})
